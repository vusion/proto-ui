...
使用`<l-common-center>`可以将内容限制在居中区域。
...
<div style="position: relative; z-index: 1; height: 500px; overflow: hidden;">
    <l-common demo>
        <l-common-center size="small" slot="head">
            <u-navbar>
...
| --------- | ---- | ------- | ----------- |
| size | String | `'normal'` | 宽度大小。可选值：`'mini'`, `'small'`, `'normal'`, `'large'`, `'huge'` |
