...
<m-singlex value="nut">
    ...
    <m-singlex-item-divider></m-singlex-item-divider>
    <m-singlex-item value="nut">坚果</m-singlex-item>
    <m-singlex-item value="towel">毛巾</m-singlex-item>
    <m-singlex-item value="sofa">沙发</m-singlex-item>
</m-singlex>
...
插入`<m-singlex-item>`、`<m-singlex-item-divider>`或`<m-singlex-group>`子组件。
...
插入`<m-singlex-item>`或`<m-singlex-item-divider>`子组件。
