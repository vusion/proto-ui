...
``` html
<u-cascade-select converter="last-value" value="应用数学" :categories="[
    { label: '学科门类' },
    { label: '一级学科' },
    { label: '二级学科' },
]" :data="[
...
``` html
<u-cascade-select empty-hidden :categories="[
    { label: '学科门类', placeholder: '学科门类' },
    { label: '一级学科', placeholder: '一级学科' },
    { label: '二级学科', placeholder: '二级学科' },
]" :data="[
...
``` vue
<template>
<u-cascade-select converter="last-value" value="计算机应用技术" @select="onSelect($event)" :categories="[
    { label: '学科门类' },
    { label: '一级学科' },
    { label: '二级学科' },
]" :data="[
...
export default {
    methods: {
        onSelect(e) {
            console.log('CascadeSelect select event:', e)
        },
    },
};
</script>
...
| emptyHidden | Boolean | `false` | 是否隐藏空列表 |
